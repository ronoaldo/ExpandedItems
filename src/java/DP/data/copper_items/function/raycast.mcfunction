...
scoreboard players remove @s copper_items.ray_steps 1

# ... and recurse if not reached zero
execute if score @s copper_items.ray_steps matches 1.. \
  positioned ^ ^ ^0.1 run function copper_items:raycast